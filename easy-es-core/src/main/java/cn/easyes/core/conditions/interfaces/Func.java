...
public interface Func<Children, R> extends Serializable {
    ...
    default Children highLight(String column) {
        return highLight(true, BaseEsConstants.HIGH_LIGHT_PRE_TAG, BaseEsConstants.HIGH_LIGHT_POST_TAG, column);
    }

    default Children highLight(boolean condition, String column) {
        return highLight(condition, BaseEsConstants.HIGH_LIGHT_PRE_TAG, BaseEsConstants.HIGH_LIGHT_POST_TAG, column);
    }

    default Children highLight(String preTag, String postTag, String column) {
        return highLight(true, preTag, postTag, column);
    }

    default Children highLight(boolean condition, String preTag, String postTag, R column) {
        return highLight(condition, preTag, postTag, FieldUtils.getFieldName(column));
    }
     ...
     * @return 泛型
     */
    Children highLight(boolean condition, String preTag, String postTag, String column);
    ...
    default Children highLight(String... columns) {
        return highLight(true, BaseEsConstants.HIGH_LIGHT_PRE_TAG, BaseEsConstants.HIGH_LIGHT_POST_TAG, columns);
    }

    default Children highLight(boolean condition, String... columns) {
        return highLight(condition, BaseEsConstants.HIGH_LIGHT_PRE_TAG, BaseEsConstants.HIGH_LIGHT_POST_TAG, columns);
    }

    default Children highLight(boolean condition, String preTag, String postTag, R... columns) {
        String[] fields = Arrays.stream(columns).map(FieldUtils::getFieldName).toArray(String[]::new);
        return highLight(condition, preTag, postTag, fields);
    }
     ...
     * @return 泛型
     */
    Children highLight(boolean condition, String preTag, String postTag, String... columns);
